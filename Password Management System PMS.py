       ...
       """)
        ...
        def submit():
            ...
            if app_name.get() != "" and url.get() != "" and email_id.get() != "" and password.get() != "":
                ...
                essagebox.showinfo("Alert", "Please fill all details!")
                conn.close()
...
def mainloginscree():
    ...
    Bcolor = Frame(loginscreen, bg="blue", width=800, height=400)
    Bcolor.pack

    mframe = Frame(loginscreen, bg="blue", width=800, height="400")
